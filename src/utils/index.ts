...
export const isNil = (value: any) => typeof value === 'object' && value !== null;
...
export const calculateOpacityColor = (hex: any, opacity: any) => {
    try {
        // validate hex string
...
export const formatDateTime = (value: any, pattern: any, locale = 'en') => {
...
export const memoization = (func: any) => {
    try {
        const cache = {};
 ...
 * @returns {Function}
 */
export const roundNumberBy = (by = 10) => (value: number) => {
    try {
        if (value > 0 && value <= 1) {
            return 1;
        }
...
export const getWidthOfText = (str: string, fontSize: any, fontFamily: string) => {
    try {
 ...
 * @returns {number|*}
 */
export const findBaseDivisorBy10 = (value: any) => {
    try {
